...
{
    /// <summary/>
    public class BanAdd : CommandObject
    {
        /// <summary>
        /// 添加封禁, 服务端或腐竹使用
        /// </summary>
        public BanAdd(Action<string> print = null) : base(CommandText.BanAdd)
        {
            ...
            CommandMethod acc = new CommandMethod(CommandText.BanAcc, 2);
