    ...
    public class ban
    {
        ...
        public class cmd : CommandObject
        {
            ...
            public cmd(bool formServer, Player formPlay = null, Dictionary<string, string> formAcc = null,
                Action<string> print = null) : base("ban")
            {
                SubCommand.Add(new CommandPrintList(SubCommand, null, print));

                CommandMethod ply = new CommandMethod("ply", 2);
                ply.SubCommand.Add(new CommandPrintList(ply.SubCommand, "\"完整玩家名\"或匹配玩家名或索引", print));
                SubCommand.Add(ply);
                ...
                ply.Runing += args =>
                {
                    ...
                    if (ex == null)
                    {
                        ...
                        PrintTo.PrintToPlayAll(ex, Color.White);
                    }
                    else
                    {
                        print?.Invoke(ex);
            ...
            /// </summary>
            public static string foo(Player banPly, bool formServer, Dictionary<string, string> formAcc = null, string msg = null)
            {
